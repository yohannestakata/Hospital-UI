function ComplaintCheckBox({ complaint, handleCheckboxChange, type }) {
  return (
    <div class="inline-flex items-center font-primary" key={complaint}>
      <label
      ...
      >
        <input
          onClick={(e) => {
            handleCheckboxChange(complaint, e.target.checked);
          }}
          id={`${complaint}-${type}`}
          value={complaint}
          type="checkbox"
...
export default ComplaintCheckBox;
